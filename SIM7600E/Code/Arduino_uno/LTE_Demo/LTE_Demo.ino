...
void setup() {
  ...
  */
  ...
  //fona.setNetworkSettings(F("m-wap"),F("mms"), F("mms")); // mobilephone
  fona.setNetworkSettings(F("v-internet"));
...
//        }
        ...
        sprintf(URL, "GET /miliohmSIM800L.php HTTP/1.1\r\nHost: miliohm.com\r\n\r\n");
        if (!fona.postData("www.miliohm.com", 80, "HTTP", URL)) // Server, port, connection type, URL
        {
          Serial.println(F("Failed to complete HTTP/HTTPS request..."));
        }          
        /*
